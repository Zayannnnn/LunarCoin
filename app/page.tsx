...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 dashboard-mesh scrollbar-thin">
      ...
      {/* Prominent Local CPU Mining Section */}
      <section className="py-20 border-t border-border/30 bg-background relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,oklch(0.75_0.15_195_/_0.03),transparent_60%)]" />
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <span className="text-xs font-mono font-semibold text-primary uppercase tracking-wider mb-2 block font-mono">Zero Cloud Dependencies</span>
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
              Local <span className="text-gradient-primary">CPU Mining</span> Engine
            </h2>
            <p className="mt-4 text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Mining works directly on your machine. We've removed cloud dependencies and Render costs so that blockchain verification remains fully local-first and transparent.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 max-w-5xl mx-auto">
            <Card className="bg-card/45 border-border/25 card-glow-hover p-5 flex flex-col items-center text-center">
              <div className="p-3 rounded-lg bg-primary/10 border border-primary/20 w-fit mb-4">
                <Cpu className="h-6 w-6 text-primary" />
              </div>
              <h3 className="font-bold text-sm mb-2">Runs On Device</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Mining uses your local CPU cores to search for valid proof-of-work nonces.
              </p>
            </Card>
            ...
            <Card className="bg-card/45 border-border/25 card-glow-hover p-5 flex flex-col items-center text-center">
              ...
              <h3 className="font-bold text-sm mb-2">No Cloud Costs</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Zero cloud computing servers. No expensive host node configuration needed.
              </p>
            </Card>
            ...
            <Card className="bg-card/45 border-border/25 card-glow-hover p-5 flex flex-col items-center text-center">
              ...
              <h3 className="font-bold text-sm mb-2">No Render Dependency</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Render-hosted APIs are completely bypassed. All computations occur on-device.
              </p>
            </Card>
            ...
            <Card className="bg-card/45 border-border/25 card-glow-hover p-5 flex flex-col items-center text-center">
              ...
              <h3 className="font-bold text-sm mb-2">Local Storage</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Blocks, keys, and transaction history are stored inside your home folder.
              </p>
            </Card>

            <Card className="bg-card/45 border-border/25 card-glow-hover p-5 flex flex-col items-center text-center">
              <div className="p-3 rounded-lg bg-primary/10 border border-primary/20 w-fit mb-4">
                <PowerOff className="h-6 w-6 text-primary" />
              </div>
              <h3 className="font-bold text-sm mb-2">Clean Shutdown</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
                All mining and backend process execution stops immediately when you close the app.
              </p>
            </Card>
          </div>
        </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <Card className="bg-card/45 border-border/25 flex flex-col justify-between p-4 card-glow-hover">
                      <div className="mb-3">
                        <h3 className="font-bold text-sm flex items-center gap-2 text-foreground font-mono">
                          <svg className="h-4 w-4 text-primary" viewBox="0 0 24 24" fill="currentColor"><path d="M0 3.449L9.75 2.1v9.45H0V3.449zM0 12.45h9.75v9.45L0 20.551v-8.1zM10.95 1.95L24 0v11.55H10.95V1.95zM10.95 12.45H24v9.6l-13.05-1.8v-7.8z"/></svg>
                          Windows OS
                        </h3>
                        <p className="text-[11px] text-muted-foreground mt-1">Portable Setup Installer</p>
                      </div>
                      <Button size="sm" className="w-full text-xs font-semibold shadow-md shadow-primary/5" asChild>
                        <Link href="#download-windows-placeholder">
                    ...
                    <Card className="bg-card/45 border-border/25 flex flex-col justify-between p-4 card-glow-hover">
                      <div className="mb-3">
                        <h3 className="font-bold text-sm flex items-center gap-2 text-foreground font-mono">
                          <svg className="h-4 w-4 text-primary" viewBox="0 0 24 24" fill="currentColor"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 4.17c.66-.81 1.11-1.93.99-3.06-.96.04-2.13.64-2.82 1.45-.6.69-1.12 1.84-.98 2.94 1.07.08 2.16-.52 2.81-1.33z"/></svg>
                          macOS
                        </h3>
                        <p className="text-[11px] text-muted-foreground mt-1">Apple Silicon & Intel DMG</p>
                      </div>
                      <Button size="sm" className="w-full text-xs font-semibold shadow-md shadow-primary/5" asChild>
                        <Link href="#download-macos-placeholder">
                          <Download className="mr-1.5 h-3.5 w-3.5" />
                          Download (.dmg)
                        </Link>
                      </Button>
                  ...
                  <div className="flex gap-3 pt-2">
                    <Button size="sm" variant="ghost" className="text-xs text-muted-foreground hover:text-foreground flex-1" asChild>
